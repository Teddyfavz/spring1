...
@Slf4j
@RestController
//@RequestMapping(path = "/api/contact", produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_XML_VALUE}) -> Using XML format for Rest Services
   ...
   // @ResponseBody
    ...
    public ResponseEntity<Response> closeMsg(@RequestBody Contact contactReq){
        ...
        if (contact.isPresent()){
            contact.get().setStatus(FavSchoolConstants.CLOSE);
