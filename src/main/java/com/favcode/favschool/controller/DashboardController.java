...
public class DashboardController {
    ...
    @Value("${favschool.pageSize}")
    private int defaultPageSize;

    @Value("${favschool.contact.successMsg}")
    ...
    private void logMessages() {
        ...
        log.error("defaultPageSize value with Environment is : " + environment.getProperty("favschool.pageSize"));
        log.error("successMsg value with Environment is : " + environment.getProperty("favschool.contact.successMsg"));
